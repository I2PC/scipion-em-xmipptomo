...
class XmippProtMonoTomoSubtomo(EMProtocol, ProtTomoBase):
    """
    ...
    def _defineParams(self, form):
        ...
        form.addParam('tomogram', PointerParam, pointerClass='SetOfTomograms',
                      ...
                      help='Select the tomogram where teh subtomograms are. If the tomogram'
    ...
    def extractSubtomosStep(self, objId):
        mytomo = self.tomogram.get()[objId]

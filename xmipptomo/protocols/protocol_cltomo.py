...
from xmipp3.convert import (writeSetOfVolumes, readSetOfClassesVol,
                            readSetOfVolumes)
...
class XmippProtCLTomo(ProtClassify3D):
    ...
    def _validate(self):
        ...
        if N0 > 0 and N0 > self.numberOfReferences.get():
            errors.append(
                "The number of initial references have to be smaller or equal than the number of final references")
        return errors
